...
public class PrefabLibraryScript : MonoBehaviour
{
	...
	public GameObject getMechChassis(int index)
	{
		...
		{ 
			Debug.LogError("Mech list is empty or request index is out of range."); 
			return null; 
		}		
	}
	...
	public GameObject getWeapon(int index)
	{
		...
		{ 
			Debug.LogError("Weapon list is empty or request index is out of range."); 
			return null; 
		}
	}
	...
	public GameObject getAbilityModule(int index)
	{
		...
		{ 
			Debug.LogError("Module list is empty or request index is out of range."); 
			return null; 
		}
	}
